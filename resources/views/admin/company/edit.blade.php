...
@section('title')
    {{__('admin/dashboard.edit_company')}} -{{$company->name}}
@endsection
@section('content')
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="{{route('index.company')}}">{{__('admin/sidebar.company')}}</a>

                                </li>
                                <li class="breadcrumb-item active">  {{__('admin/dashboard.edit_company')}} -{{$company->name}}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="card-body">
                                            <form class="form" method="post"
                                                ...
                                                <h4 class="form-section"><i
                                                        class="ft-home"></i>{{__('admin/dashboard.edit_company')}} -  {{$company->name}}
                                                </h4>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="name_ar" class="form-control"
                                                                       name="name_ar" value="{{$company->getTranslation('name', 'ar')}}">
                                                                @error('name_ar')
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="name_en" class="form-control"
                                                                       name="name_en" value="{{$company->getTranslation('name', 'en')}}">
                                                                @error('name_en')
                                                ...
                                                <div class="form-actions">
                                                    <a href="{{route('index.company')}}" type="button" class="btn btn-warning mr-1" data-dismiss="modal">
