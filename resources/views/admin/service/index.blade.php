...
@section('content')
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">    {{__('admin/sidebar.service')}}</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('admin/sidebar.main')}}</a></li>
                                <li class="breadcrumb-item active">   {{__('admin/sidebar.service')}} </li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <a class="btn btn-outline-success float-left" href="javascript:void(0)"
                                       id="addNewService"><i class="la la-plus"></i> {{__('admin/dashboard.add_a_new_service')}}</a>
    ...
    <div class="modal fade modal-open" id="service-modal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content width-800">
                <div class="modal-header">
                    <h4 class="modal-title form-section" id="modalheader">
                        <i class="ft-home"></i> {{__('admin/dashboard.add_a_new_service')}}
                    </h4>
                ...
                <div class="modal-body">
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <form class="form" id="serviceForm" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="short_description_ar" id="short_description_ar" cols="15"
                                                          rows="15" class="form-control">{{old('short_description_ar')}}</textarea>
                                            </div>
                                            <span id="short_description_ar_error" class="text-danger"></span>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="short_description_en" id="short_description_en" cols="15"
                                                          rows="15" class="form-control">{{old('short_description_en')}}</textarea>
                                            </div>
                                            <span id="short_description_en_error" class="text-danger"></span>
                                        </div>
                                    </div>
                                ...
                                <div class="form-actions">
                                    ...
                                    <button class="btn btn-primary" id="addService"><i class="la la-save"></i> {{__('admin/dashboard.save')}}</button>
                                </div>
            ...
            <div class="modal-content">
                ...
                <form id="delete_modal_form">
                    ...
                    <div class="modal-body">
                        ...
                        <h5>{{__('admin/dashboard.alert_delete_service')}}</h5>
                    </div>
