...
@section('content')
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">{{__('admin/sidebar.useful_links')}}</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('admin/sidebar.main')}} </a></li>
                                <li class="breadcrumb-item active">{{__('admin/sidebar.useful_links')}}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <a class="btn btn-outline-success float-left" href="javascript:void(0)"
                                       id="addNewUsefulLinks"><i class="la la-plus"></i>{{__('admin/dashboard.add_a_new_useful_links')}}</a>
                                ...
                                <div class="card-content collapse show" id="viewAboutUs">
                                    <div class="card-body card-dashboard table-responsive">
                                        <table class="table useful_links-table">
                                            <thead>
                                            <tr>
    ...
    <div class="modal fade modal-open" id="UsefulLinks-modal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content width-500">
                <div class="modal-header">
                    <h4 class="modal-title form-section" id="modalheader">
                        <i class="ft-home"></i> {{__('admin/dashboard.add_a_new_useful_links')}}
                    </h4>
                ...
                <div class="modal-body">
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <form class="form" id="usefulLinksForm" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-actions">
                                    ...
                                    <button class="btn btn-primary" id="addUsefulLinks"><i class="la la-save"></i>  {{__('admin/dashboard.save')}}</button>
                                </div>
            ...
            <div class="modal-content">
                ...
                <form id="delete_modal_form">
                    ...
                    <div class="modal-body">
                        ...
                        <h5>{{__('admin/dashboard.alert_delete_useful_links')}}</h5>
                    </div>
...
@section('script')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //Show Table
            var usefulLinksTable = $('.useful_links-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{route("index.useful_links")}}",
                columns: [
                    {data: 'name', name: 'name'},
                    {data: 'link', name: 'link'},
            ...
            //Show Form
            $('#addNewUsefulLinks').click(function () {
                $('#usefulLinksForm').trigger('reset');
                $('#UsefulLinks-modal').modal('show');

            });


            //Add Or Update
            $(document).on('click', '#addUsefulLinks', function (e) {
                e.preventDefault();

                var formData = new FormData($('#usefulLinksForm')[0]);
                $('#name_ar_error').text('');
                $('#name_en_error').text('');
                $('#link_error').text('');
                $.ajax({
                    type: 'post',
                    url: "{{ route('save.useful_links') }}",
                    ...
                    success: function (data) {
                        if (data.status == true) {
                            ...
                            $('#usefulLinksForm').trigger('reset');
                            $('#UsefulLinks-modal').modal('hide');
                            usefulLinksTable.draw();
                        } else {
            ...
            $('body').on('click', '.deleteUsefulLinks', function () {
                var id = $(this).data('id');
