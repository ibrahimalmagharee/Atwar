...
@section('content')
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title"> {{__('admin/sidebar.news_tap')}}</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('admin/sidebar.main')}} </a></li>
                                <li class="breadcrumb-item active">{{__('admin/sidebar.news_tap')}}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <a class="btn btn-outline-success float-left" href="javascript:void(0)"
                                       id="addNewNewsTap"><i class="la la-plus"></i>{{__('admin/dashboard.add_a_new_news_tap')}}</a>
                                ...
                                <div class="card-content collapse show" id="viewAboutUs">
                                    <div class="card-body card-dashboard table-responsive">
                                        <table class="table newsTap-table">
                                            <thead>
                                            <tr>
    ...
    <div class="modal fade modal-open" id="newsTap-modal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content width-800">
                <div class="modal-header">
                    <h4 class="modal-title form-section" id="modalheader">
                        <i class="ft-home"></i>{{__('admin/dashboard.add_a_new_news_tap')}}
                    </h4>
                ...
                <div class="modal-body">
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <form class="form" id="newsTapForm" enctype="multipart/form-data">
                                @csrf
            ...
            <div class="modal-content">
                ...
                <form id="delete_modal_form">
                    ...
                    <div class="modal-body">
                        ...
                        <h5>{{__('admin/dashboard.alert_delete_news_tap')}}</h5>
                    </div>
...
@section('script')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //Show Table
            var newsTapTable = $('.newsTap-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{route("index.news_tap")}}",
                columns: [
            ...
            //Show Form
            $('#addNewNewsTap').click(function () {
                $('#newsTapForm').trigger('reset');
                $('#newsTap-modal').modal('show');
            ...
            $(document).on('click', '#addAboutUs', function (e) {
                ...
                var formData = new FormData($('#newsTapForm')[0]);
                $('#description_ar_error').text('');
                $('#description_en_error').text('');
                $.ajax({
                    type: 'post',
                    url: "{{ route('save.news_tap') }}",
            ...
            $('body').on('click', '.deleteNewsTap', function () {
                var id = $(this).data('id');
