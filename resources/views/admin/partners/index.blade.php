...
@section('content')
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">{{__('admin/sidebar.partners')}} </h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('admin/sidebar.main')}} </a></li>
                                <li class="breadcrumb-item active"> {{__('admin/sidebar.partners')}}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <a class="btn btn-outline-success float-left" href="javascript:void(0)"
                                       id="addNewPartner"><i class="la la-plus"></i> {{__('admin/dashboard.add_a_new_partner')}}</a>
                                    ...
                                    <div class="card-body card-dashboard table-responsive">
                                        <table class="table partner-table">
                                            ...
                                            <tr>
                                                ...
                                                <th>{{__('admin/dashboard.partner')}}</th>
    ...
    <div class="modal fade modal-open" id="partner-modal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content width-800">
                <div class="modal-header">
                    <h4 class="modal-title form-section" id="modalheader">
                        <i class="ft-home"></i>  {{__('admin/dashboard.add_a_new_partner')}}
                    </h4>
                ...
                <div class="modal-body">
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <form class="form" id="partnerForm" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mt-1">
                                                ...
                                                <label class="card-title ml-1">{{__('admin/dashboard.partner')}}</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group mt-1">
                                                ...
                                                <label class="card-title ml-1">{{__('admin/dashboard.content_partner')}}</label>
                                    ...
                                    <div class="row hidden partners_list" id="partners_list">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row hidden partners_list">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                ...
                                <div class="form-actions">
                                    ...
                                    <button class="btn btn-primary" id="addPartner"><i class="la la-save"></i> {{__('admin/dashboard.save')}}</button>
                                </div>
            ...
            <div class="modal-content">
                ...
                <form id="delete_modal_form">
                    ...
                    <div class="modal-body">
                        ...
                        <h5>{{__('admin/dashboard.alert_delete_partner')}}</h5>
                    </div>
            ...
            $('input:radio[name="type"]').change(
                function () {
                    if (this.checked && this.value == 2){
                        $('.partners_list').removeClass('hidden');
                    }else{
                        $('.partners_list').addClass('hidden');
                    }
                });
