...
@section('content')
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2">
                    <h3 class="content-header-title">{{__('admin/sidebar.social_link')}}</h3>
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{__('admin/sidebar.main')}} </a></li>
                                <li class="breadcrumb-item active">{{__('admin/sidebar.social_link')}}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <a class="btn btn-outline-success float-left" href="javascript:void(0)"
                                       id="addNewSocialLink"><i class="la la-plus"></i>{{__('admin/dashboard.add_a_new_social_link')}}</a>
                                ...
                                <div class="card-content collapse show" id="viewAboutUs">
                                    <div class="card-body card-dashboard table-responsive">
                                        <table class="table social_link-table">
                                            <thead>
                                            <tr>
    ...
    <div class="modal fade modal-open" id="SocialLink-modal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content width-500">
                <div class="modal-header">
                    <h4 class="modal-title form-section" id="modalheader">
                        <i class="ft-home"></i> {{__('admin/dashboard.add_a_new_social_link')}}
                    </h4>
                ...
                <div class="modal-body">
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <form class="form" id="socialLinkForm" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-actions">
                                    ...
                                    <button class="btn btn-primary" id="addSocialLink"><i class="la la-save"></i>  {{__('admin/dashboard.save')}}</button>
                                </div>
            ...
            <div class="modal-content">
                ...
                <form id="delete_modal_form">
                    ...
                    <div class="modal-body">
                        ...
                        <h5>{{__('admin/dashboard.alert_delete_social_link')}}</h5>
                    </div>
...
@section('script')
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //Show Table
            var socialLinkTable = $('.social_link-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{route("index.social_link")}}",
                columns: [
                    {data: 'name', name: 'name'},
                    {data: 'link', name: 'link'},
            ...
            //Show Form
            $('#addNewSocialLink').click(function () {
                $('#socialLinkForm').trigger('reset');
                $('#SocialLink-modal').modal('show');

            });


            //Add Or Update
            $(document).on('click', '#addSocialLink', function (e) {
                e.preventDefault();

                var formData = new FormData($('#socialLinkForm')[0]);
                $('#name_ar_error').text('');
                $('#name_en_error').text('');
                $('#link_error').text('');
                $('#photo_error').text('');
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.status == true) {
                            ...
                            $('#socialLinkForm').trigger('reset');
                            $('#SocialLink-modal').modal('hide');
                            socialLinkTable.draw();
                        } else {
