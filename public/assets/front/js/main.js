...
var buttonSelector = '#deleteButton'
...
function openPage(pageName,elmnt,color) {
    ...
    for (i = 0; i < tablinks.length; i++) {
      tablinks[i].style.borderBottom = "2px solid #E8E8E8";


    }
    document.getElementById(pageName).style.display = "block";

    elmnt.style.borderBottom = "2px solid silver";

  }

  var elemet =document.getElementById("defaultOpen")
if ( elemet ) {
