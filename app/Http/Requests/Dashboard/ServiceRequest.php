...
class ServiceRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'short_description_ar' => 'required|max:1000',
            'short_description_en' => 'required|max:1000',
    ...
    public function messages()
    {
        return [
            ...
            'short_description_ar.required' => __('admin/dashboard.short_description_ar_required'),
            'short_description_ar.max' => __('admin/dashboard.short_description_ar_max'),
            'short_description_en.required' => __('admin/dashboard.short_description_en_required'),
            'short_description_en.max' => __('admin/dashboard.short_description_en_max'),
